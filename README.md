...
此代码库生成的gitbook已经部署在本项目主页https://SystemDynamicsCommunity.github.io/systemdynamics ，直接访问该gitbook，可以了解最新版本的内容。
...
4. 修改提交之后，Travis会自动将修改部署到本[项目主页](https://SystemDynamicsCommunity.github.io/systemdynamics "System Dynamics") ，您可以提交代码后，等待片刻，访问页面确定修改是否生效。
